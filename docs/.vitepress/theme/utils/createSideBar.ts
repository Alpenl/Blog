  ...
  return {
    "/notes/": [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: "ChatGPT提示学习笔记1_2", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记1_2" },
          { text: "ChatGPT提示学习笔记3", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记3" },
          { text: "ChatGPT提示学习笔记4", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记4" },
          { text: "ChatGPT提示学习笔记5", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记5" },
          { text: "ChatGPT提示学习笔记6", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记6" },
          { text: "ChatGPT提示学习笔记7", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记7" },
          { text: "ChatGPT提示学习笔记8", link: "/notes/ChatGPT提示学习/ChatGPT提示学习笔记8" }
        ]
      },
      {
        text: "CSS相关",
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: "01Vue3是如何运行的", link: "/notes/Vue相关/01Vue3是如何运行的" },
